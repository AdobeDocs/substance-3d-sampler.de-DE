---
breadcrumb-title: ''
description: Erfahren Sie mehr über Materialvorgaben, wie Sie eine Vorgabe auf Ihr Material anwenden und wie Sie benutzerdefinierte Vorgaben erstellen und verwalten.
...
Passen Sie die Materialeinstellungen (Name, Auflösung, Materialmodell, Kanäle) an.
...
* Basismaterial
Ein physikalisch basiertes Standardmaterial mit häufig verwendeten Kanälen. Verwenden Sie diese Vorlage für einfache oder generische Materialien, für die kein spezielles Verhalten erforderlich ist.
...
* Fuzz
Ermöglicht weiche, lichtstreuende Oberflächeneffekte, die für Gewebe, Fasern oder Materialien mit samtigem Aussehen verwendet werden.

* Volumen
Aktiviert den Untergrund-Lichttransport für Materialien wie Wachs, Kunststoffe oder organische Oberflächen, bei denen Licht unter die Oberfläche eindringt.

* Transparent
Konfiguriert das Material für die Lichtdurchlässigkeit, geeignet für glasartige oder dünne transparente Materialien.
