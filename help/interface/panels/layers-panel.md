...
1. Der Werkzeugbereich enthält Schaltflächen, mit denen Sie
   ...
   1. Ebene entfernen
1. Mit dem Selektor &quot;**Füllmethode&quot; &quot;**&quot; können Sie anpassen, wie eine Ebene mit den darunter liegenden Ebenen überblendet wird. Der Selektor &quot;**Füllmethode&quot; &quot;**&quot; ist nur verfügbar, wenn eine Materialebene ausgewählt ist. Filter verwenden keine Füllmethoden.
1. Der **Ebenenstapel** enthält alle Ebenen, aus denen sich Ihr Asset zusammensetzt.
...
| Alle Ebenenauflösung wechseln | Klicken Sie auf den Pfeil neben der Schaltfläche &quot;Auflösung ein-/ausblenden&quot; und wählen Sie die Strategie für alle Ebenen im Stapel aus. |
...
Eine Materialebene enthält Informationen in mehreren Kanälen und kann mit den darunter liegenden Ebenen vermischt werden. Die Anzeige von Materialebenen unterscheidet sich geringfügig, je nachdem, ob sie sich am unteren Rand des Stapels befinden oder nicht. Zum Beispiel zeigt das Bild unten ein Felsmaterial, das zweimal in den Ebenenstapel gezogen wurde. Beachten Sie, dass die untere Ebene kein Symbol enthält, um die Überblendung zu steuern, während die obere Ebene dies tut.

![Materialebenen im Ebenenstapel, die oberste Ebene verfügt über eine Überblendungsoption.](../../assets/Material-Layer.png)

Die allgemeinen Regeln für Materialschichten sind:

* Eine Materialebene verwendet immer die Dokumentauflösung.
* Eine Materialebene am unteren Rand des Stapels kann nicht überblendet werden, sodass der Selektor &quot;**Füllmethode&quot; &quot;**&quot; nicht verfügbar ist.
* Eine Materialebene, die sich nicht am unteren Rand des Stapels befindet, kann mit den darunter liegenden Ebenen überblendet werden. Daher können Sie den Mischmodus mit der **Auswahl des Mischmodus** ändern. Außerdem wird neben dem **Ebenensymbol** ein **Überblendungssymbol** angezeigt. Wählen Sie das Symbol **Angleichen** aus, um die Angleichungseinstellungen für die Ebene anzupassen, je nachdem, welcher Angleichungsmodus ausgewählt wurde.
...
* Der **Materialfilter** kann ein Atlas Scatter als Eingabe verwenden.
* Der **Atlas Scatter-Filter** Streuung Instanzen aus dem Eingabematlas-Material auf der Grundlage der **Atlas Scatter**-Parameter.
...
Bildebenen verwenden ihre eigene Auflösung und befinden sich hauptsächlich im Workflow &quot;Bild zu Material&quot;. Wie bei Materialebenen können Sie eine Bildebene erstellen, indem Sie ein Bild aus dem **Bedienfeld &quot;Elemente&quot;** ziehen.

Sie können ein Bild aus dem Dateibrowser Ihres Systems in Sampler ziehen. Wenn sich bereits Ebenen in Ihrem Ebenenstapel befinden, wird die Bildebene an oberster Stelle im Stapel eingefügt. Wenn der Ebenenstapel keine Ebenen enthält, wird ein Dialogfeld angezeigt, in dem Sie auswählen können, wie das Bild verarbeitet werden soll:

* Mit **Bild zu Material** können Sie mithilfe von KI ein Bild in ein Material konvertieren.
...
* Mit **Texturimport** können Sie importierte Bilder als Texturkanäle verwenden, um ein Material aufzubauen.
* **Als Bitmap verwenden** importiert das Bild als einfache Bitmapebene.

Sie können auch mehrere ausgewählte Bilder gleichzeitig in den Ebenenstapel ziehen, um sie alle als eine einzelne Ebene zu importieren. Dies kann bei Filtern mit mehreren Bildern wie **HDR-Zusammenfügung** und **Mehrwinkel zu Material** hilfreich sein. Wählen Sie die Ebene mit mehreren Bildern aus, um die Kanaldaten für jedes Bild zu ändern.
