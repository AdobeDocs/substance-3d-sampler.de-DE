...
## Basisausrüstung und -einrichtung
...
Eine DSLR, ein Stativ und eine Drehscheibe reichen bereits aus, um einfache Objekte unter idealen Bedingungen einzufangen. Das bedeutet, mit gleichmäßigem natürlichem Licht zu fotografieren, z. B. von einem Deckenfenster oder mehreren umliegenden Fenstern. Die Objektaufnahme sollte ebenfalls ziemlich matt sein und nicht viel reflektieren.

Die wichtigste Sache, auf die du achten solltest, ist ein einheitlicher Hintergrund. Das photogrammmetrische System wird leicht durch einen statischen Hintergrund mit einem rotierenden Objekt verwechselt, weshalb es wichtig ist, diesen Faktor zu eliminieren. Wenn es einen geschäftigen Hintergrund gibt, kann man ein einfaches Papier- oder Kartonblatt oder ein einheitlich gefärbtes Tuch verwenden, um Dinge zu verbergen.

Sobald alles eingerichtet ist, ist die Idee einfach: viele Fotos machen, <b>in vollen 360-Grad-Schleifen laufen. 16 Schüsse pro Umdrehung sind eine gute Anzahl, in mindestens 5 verschiedenen Schleifen</b>. Ein <b> von der Seite</b> und <b>zwei von verschiedenen Heights</b> für das untere und das obere.

Informieren Sie sich jetzt über die c[Kameraeinstellungen, die Sie für die 3D-Erfassung verwenden müssen](camera-settings-exposure-substance-3d-sampler.md).
