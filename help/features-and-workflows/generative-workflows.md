...
Mit Substance 3D Sampler können Sie schnell iterieren und neue Ideen einfach ausprobieren. Drei generative Funktionen sind derzeit in der Beta-Version verfügbar: &quot;Text-zu-Textur&quot;, &quot;Text-zu-Muster&quot; und &quot;Bild-zu-Textur&quot;.
...
Mit &quot;Text-zu-Muster&quot; können Sie schnell Muster aus einer Textaufforderung generieren, sodass sie auf jede beliebige Oberfläche angewendet werden können.

So verwenden Sie Text-zu-Muster:

1. Öffnen Sie den Bereich <b>Generative (Beta) </b> in der linken Symbolleiste.
1. Wählen Sie &quot;<b>Pattern</b>&quot; in der Dropdownliste &quot;Typ&quot; aus.
1. Geben Sie eine Textaufforderung ein, die das Muster beschreibt, das Sie erstellen möchten.
1. Verwenden Sie <b>Generieren</b>, um mit dem Generieren von Mustern zu beginnen. Bei jeder Verwendung der Funktion werden vier Varianten generiert.
1. Sie können ihn als Eingabe eines <b>Musterfilters</b> oder direkt zu <b>Ebenen</b> über die dedizierten Schaltflächen hinzufügen. Sie können das Ergebnis auch Ihrer <b>Assets</b>-Bibliothek hinzufügen, um es später leicht wiederzufinden.
...
Fügen Sie dem Eingabefeld <b>Wörter oder Ausdrücke</b> hinzu, die die <b>Textur</b> oder <b>Muster</b> beschreiben, die Sie generieren möchten. Durch die Spezifizierung haben Sie mehr Kontrolle über die generierten Ergebnisse.

Um <b>eine oder mehrere bestimmte Eingabeaufforderungen auszuschließen</b>, können Sie bis zu 10 Wörter oder Ausdrücke hinzufügen, um dies bei der Verarbeitung Ihrer Eingabeaufforderung zu vermeiden. Schreiben Sie &quot;<b>—no</b>&quot; vor die Wörter oder Ausdrücke, die Sie ausschließen möchten. 

Sie können auch die <b>Beispiele</b> im Bedienfeld &quot;Generativ (Beta)&quot; verwenden, um Promptideen zu erkunden.

## Generative Credits

Die generativen Funktionen von Sampler verwenden keine Credits, während die Funktionen in der Beta-Version verfügbar sind.

In den <b>Häufigen Fragen zu generativen Credits</b> finden Sie die neuesten Informationen zur Funktionsweise von generativen Credits in Adobe-Tools.
