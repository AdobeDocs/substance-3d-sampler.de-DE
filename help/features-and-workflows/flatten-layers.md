...
Auf alle Ebenen, die abgeflacht werden, kann im Ebenenstapel nicht einzeln zugegriffen werden, sodass Sie keine Änderungen an den Parametern im abgeflachten Ergebnis vornehmen können. Daher sollten Sie Ebenen nur reduzieren, wenn Sie keine Änderungen an den Ergebnissen dieser Ebenen mehr vornehmen müssen.
...
* <b>Deckkraft aus Alphakanal</b>: Stellt ein, ob die Deckkraft auf dem Ergebnis des Alphakanals basiert.
