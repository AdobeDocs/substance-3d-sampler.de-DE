...
breadcrumb-title: ''
description: Lesen Sie die Versionshinweise für Substance 3D Sampler 4.2, um mehr über KI-gestützte "Bild zu Material", die Funktion "KI-Hochskalierung" und die Auflösungsoptionen zu erfahren.
...
<b>Substance 3D Sampler 4.2</b> führt eine neue KI-gestützte Version von <b>Image to Material</b> und eine neue <b>AI Upscale</b>-Funktion ein. Diese Version bietet die vollständige Kontrolle über die Auflösung pro Ebene.

*Freigabedatum: 05. September 2023*

## Bild zu Material - Neue Version

![](../assets/sa_whats-new-screen_v4-2-0_image_to_material.png)

&quot;Bild zu Material&quot; erzeugt aus einem einzigen Bild Materialkanäle (Grundfarbe, Raueit, Normal, Versatz und Metall) für Sie.

Die aktualisierte Version von &quot;Bild zu Material&quot; verbessert die Materialgenerierung und den unterstützten Materialbereich.

&quot;Bild zu Material&quot; wurde jetzt für alle Materialtypen geschult und generiert bessere Ergebnisse für Gewebe, Kunststoff, Holz usw.

Die aktualisierte Version verfügt über einen neuen Parameter, mit dem Sie den Materialtyp auswählen können, um alle Kanäle genau zu generieren und den Bereich automatisch anzupassen.
...
Dies ermöglicht es, die Qualität und den Detailgrad von Texturen mit niedriger Auflösung zu erhöhen, um die Funktionskohärenz zwischen Maps während der Texturvergrößerung aufrechtzuerhalten.

Der Hochskalieren-Filter verbessert die Grundfarbe, die Normalität, das Height, die Raueit und die Metallkanäle Ihres Materials.

Um die Ergebnisqualität zu maximieren, sollte der Hochskalieren-Filter für Daten (Material und Bild) mit ihrer ursprünglichen Auflösung verwendet werden, ohne dass zuvor eine Änderung der Auflösung vorgenommen wurde.
...
Die Auflösung wird auf jeder Ebene angezeigt, um den Einfluss Ihrer Arbeit auf die Auflösung Ihres Materials leicht zu visualisieren.

Auf diese Weise können Sie die Qualität Ihrer Materialien steigern, aber auch die Leistung, während Sie an Ihren Elementen arbeiten.
...
* [Vorlage zur Materialerstellung] Einstellung &quot;Dokumentgröße hinzufügen&quot;.
* [Vorlage für Materialerstellung] Neue Umschalttaste &quot;Zuschnitt hinzufügen&quot;.
* [Vorlage für Materialerstellung] Neue Umschalttaste &quot;Material hochskalieren&quot;
* [Materialerstellungsvorlage] Importierte Bildgröße anzeigen
* [Vorlage zur Materialerstellung] Feedback geben, wenn einige importierte Bilder nicht verwendet werden können
* [Vorlage zur Materialerstellung] Warnung bei inkonsistenten Bildgrößen
* [Vorlage zur Materialerstellung] Neue Warnungen und QuickInfos
* [Ebenen] Anzeigen der Auflösung der Ebenen im Ebenenstapel
...
* [Exportieren] Überschreiben der Auflösung exportierter Texturen zulassen
...
* [UI] Neue Symbole für die Filter &quot;Gittertransformation&quot;, &quot;Gitternachbearbeitung&quot; und &quot;Weben&quot;
...
* [Engine] Update-Substance Engine auf Version 9.0.1
...
* [Anwendung] Absturz beim Duplizieren eines Assets im Projektfenster
* [Anwendung] Absturz beim Wechseln von Elementen im Projektfenster
* [Inhalt] Das Malen einer benutzerdefinierten Maske für den Snow-Filter funktioniert nicht richtig
* [Verfügbare Parameter] Verfügbare Parameteränderungen können beim Wechseln von Materialien verloren gehen.
* [Interoperabilität] Das Senden eines Materials aus dem Exportbedienfeld kann zu einem Absturz führen
* [Ebenen] Die inhaltsbasierte Füllung wird nicht mehr berechnet, wenn von einem einzelnen Bildeingang zu einem Materialeingang gewechselt wird
...
* [UI] 3D-Ansichtsport-Onboarding-QuickInfo hat Fokusprobleme
...
* [UI] Wenn die QuickInfo für das Ansichtsfenster angezeigt wird, wird durch Drücken von &quot;Leertaste&quot; ein neues Projekt erstellt.
