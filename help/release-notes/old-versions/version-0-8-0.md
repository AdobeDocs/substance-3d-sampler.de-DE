...
* [Ressourcen] Verbinden und spiegeln Sie Ihre Materialordner auf Ihren lokalen Festplatten
* [Ressourcen] Durchsuchen Sie Ihre Materialordner und deren Unterordner
...
* [Verwalten] Hinzufügen, Bearbeiten und Löschen von Tags Ihrer Materialien
* [Verwalten] Material bewerten
...
* [UX] Erstellen Sie keine Basisebene oder öffnen Sie das Popup &quot;Material Workflow&quot;, wenn Sie Bilder in einem nicht leeren Ebenenstapel importieren.
* [UI] Neues Textfeldformat
* [UI] Neues Suchfeld-Format
* [UI] Neuer Kopfzeilenstil für Bedienfelder
* [UI] Neuer Anzeigestil &quot;Gebucht&quot;
* [UI] Neue Ebenen stapeln Hintergrundstil
* [UI] Adobe Clean-Schriftart verwenden
* [UI] Pipettensymbol-Platzhalter für Farbeingabeparameter entfernen
...
* [Inspiration] Beheben von Abstürzen bei Verwendung von mehr als 10 Farben
* [2D-Ansicht] Fixieren der Bildlaufleiste in der Kanalliste der 2D-Ansicht
* [Viewer] Beheben Sie den Absturz beim Importieren einer Umgebungskarte ohne Stromversorgung von 2
