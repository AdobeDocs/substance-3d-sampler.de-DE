...
* **Exportvorgaben zum Packen von Texturen für einen bestimmten Renderer oder eine bestimmte Game-Engine verwenden** Es ist jetzt möglich, während des Exportvorgangs eine Konfiguration aus einer Liste von Exportvorgaben auszuwählen, die die Texturen für eine bestimmte Anwendung eines Drittanbieters konvertieren, packen und benennen. Das Ergebnis dieser Konvertierung wird in der Kanalliste auf der rechten Seite der Benutzeroberfläche angezeigt.\
  Der neue Exporteur enthält standardmäßig die folgenden Vorgaben:
...
* **Exporteinstellungen werden gespeichert und beim nächsten Export wiederhergestellt**\
  Wenn Sie das Exportfenster erneut öffnen, werden auch die zuvor verwendeten Exporteinstellungen verwendet, um den Vorgang komfortabler zu gestalten. So können Sie Material einfacher und schneller erneut exportieren.
...
Weitere Informationen zum Erstellen und Verwenden einer Konfigurationsdatei finden Sie auf der dedizierten [Dokumentationsseite](https://helpx.adobe.com/substance-3d/unlisted/documentation/sadoc/resources-configuration-file-188976187.html).
...
* **Fokus der 2D-Ansicht**\
  Es ist jetzt möglich, den Tastaturbefehl &quot;F&quot; zu verwenden, um die 2D-Ansicht zurückzusetzen und zu zentrieren, genau wie bei der 3D-Ansicht.
* **Letztes Projekt erneut öffnen**\
  Um die Erstellung von Inhalten zu vereinfachen und zu beschleunigen, öffnet die Anwendung jetzt das zuletzt verwendete Projekt erneut. Das Create-Labor ist jetzt auch der Standardmodus beim Öffnen der Anwendung.
...
* **Neue Startermaterialien**\
  Wir haben einige vorhandene Materialien durch neue ersetzt. Hier ist die Liste der neuen Materialien:
  ...
  * Wollstoff
  * Gewebe
* **Metallische Steuerung mit Bitmap 2 Materialfilter**\
  Der Bitmap 2-Materialfilter wurde aktualisiert, um mehr Kontrolle über den metallischen Kanal zu bieten. Es ist jetzt möglich, eine benutzerdefinierte Bitmapeingabe dafür zu verwenden oder eine einheitliche Farbe zu definieren.
* **Verbesserter Korrekturfilter**\
  Der Anpassungsfilter kann jetzt mit dem Projektset arbeiten, um den PBR-Workflow &quot;Specular/Glossiness&quot; zu verwenden.
* **Neue Atlas Scatter-Parameter**\
  Wir haben einige neue Parameter hinzugefügt, die eine bessere Kontrolle darüber bieten, wie sich die Height mit der Materialkarte des darunter liegenden Materials mischen.
...
* [Exportieren] Exportieren Sie die voreingestellte Auswahl, um Ihre Texturen für Renderer und Game-Engines zu verpacken
...
* [Exportieren] Exportieren einer Vorgabe in PBR Specular Glossiness aus PBR Metallic Roughness
...
* [Anwendung] Öffnen Sie &quot;Beim Start erstellen&quot; und ändern Sie die Laborreihenfolge.
* [Begrüßungsbildschirm] Neues Begrüßungsbanner
* [Projekt] Letztes Projekt beim Start öffnen
* [UI] Neuer Kombinationsfeldstil
* [2D-Ansicht] F-Verknüpfung zum Fokus in der 2D-Ansicht
* [Filter] Neue Unterstützung für das alchemist::parameterVisibility-Tag in Substance-Graphen
...
* [Inhalt] Neue Startmaterialien
* [Inhalt] Bitmap zu Material : Fügen Sie die Möglichkeit hinzu, den metallischen Kanal zu definieren (einheitlich, benutzerdefinierter Bildimport, Farbauswahl).
* [Content] Anpassung - Unterstützung des PBR-Workflows für Specular/Glanz hinzufügen
* Atlas Scatter [Inhalt] - Neue Parameter

**Fest:**

* [Projekt] Absturz beim zweimaligen Importieren desselben Projekts
* [Project] Absturz beim mehrmaligen Importieren und Öffnen von Projekten behoben
* [Anwendung] Absturz beim Laden eines unbenannten Materials
* [Anwendung] Erkennen fehlender Dateien beim erneuten Importieren
* [Anwendung] Beheben eines zufälligen Absturzes beim Herunterfahren
...
* [Ebenen] Absturz bei Verwendung von Clone Patch
...
* [Ressourcen] Verhindern des Einfrierens beim Massenklicken auf einen Stapel in der Bibliothek
* [Ressourcen] Leistungseinbußen beim erneuten Hinzufügen eines zuvor hinzugefügten verknüpften Ordners
* [Ressourcen] Absturz beim Versuch, eine gelöschte .sbsar-Datei zu öffnen, behoben
* [Leistung] Vermeiden Sie das Laden von Materialien, um auf die Parameter zuzugreifen.
* [Performance] Sichern von Assets nur bei Verwendung in einem Projekt oder in einem erstellten Material
* [Export] Fixierte Materialien in der Exportwarteschlange werden manchmal übersprungen oder mit falschen Parametern exportiert
* [2D-Ansicht] Wiederhergestellter Schwenk- und Zoom
* [Inhalt] Das Parkettmuster berücksichtigt den Kanal für die umgebende Verdeckung.
* [Inhalt] Malen - Maskeneingabe anzeigen, wenn benutzerdefinierte Maske aktiviert wird
* [Content] Stonewall Pattern - Entfernen Sie mögliche Streifeneffekte in der normalen Karte
* [Content] Height Modulation - Korrigieren von doppelten Grundfarbeinträgen in der 2D-Ansicht
